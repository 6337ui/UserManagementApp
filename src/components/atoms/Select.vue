...
const baseClasses = 'rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 w-full appearance-none bg-no-repeat bg-[right_1rem_center] bg-[length:1rem_1rem]';
